...
!(function (e, n, t) {
    ...
    function d(e, n, t) {
        ...
        for (var s in e) {
            if (e[s] in n) {
                return t === !1 ? e[s] : ((o = n[e[s]]), r(o, 'function') ? c(o, t || n) : o);
            }
        }
        return !1;
    }
    ...
    function v(e, n, o, s) {
        ...
        for (var c, d, p, m, v, g = ['modernizr', 'tspan', 'samp']; !N.style && g.length; ) {
            ((c = !0), (N.modElem = i(g.shift())), (N.style = N.modElem.style));
        }
        for (p = e.length, d = 0; p > d; d++) {
            if (((m = e[d]), (v = N.style[m]), a(m, '-') && (m = l(m)), N.style[m] !== t)) {
                if (s || r(o, 'undefined')) {
                    return (u(), 'pfx' == n ? m : !0);
                }
                try {
