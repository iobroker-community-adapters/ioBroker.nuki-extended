...
module.exports = {
    ...
    // INFO
    bridgeApiCallback: {
        node: 'info.bridgeApiSync',
        description: 'Indicates whether syncing via Bridge API is activated',
        role: 'indicator',
        type: 'boolean',
    },
    bridgeApiSync: {
    ...
    bridgeApiLast: {
        node: 'info.bridgeApiLast',
        description: 'Timestamp of last Bridge API sync or callback',
        role: 'date',
    },
    webApiSync: {
        node: 'info.webApiSync',
        description: 'Indicates whether syncing via Web API is activated',
        role: 'indicator',
        type: 'boolean',
    },
    ...
    'notifications.settings.authIds': {
        description:
    ...
    'notifications.settings.triggerEvents': {
        description:
    ...
    'notifications.settings.smartlockId': {
    ...
    'notifications.status': {
        ...
        type: 'number',
        role: 'indicator',
        common: { states: { 0: 'INIT', 1: 'ACTIVE', 2: 'FAILED' } },
    },
    ...
    'notifications.os': {
        ...
        type: 'number',
        role: 'text',
        common: { states: { 0: 'Android', 1: 'iOS', 2: 'Webhook' } },
    },
    ...
    bridgeType: {
        ...
        type: 'number',
        role: 'value',
        common: { states: { 1: 'Hardware Bridge', 2: 'Software Bridge' } },
    },
    ...
    serverConnected: {
        state: '_connected',
        description: 'Flag indicating whether or not the bridge is connected to the Nuki server',
        type: 'boolean',
    ...
    'versions.firmwareVersion': {
        state: 'versFirmware',
        description: 'Version of the bridges firmware (hardware bridge only)',
        role: 'text',
    },
    'versions.wifiFirmwareVersion': {
        state: 'versWifi',
        description: 'Version of the WiFi modules firmwarehardware bridge only',
        role: 'text',
    },
    'versions.appVersion': {
        state: 'versApp',
        description: 'Version of the bridge appsoftware bridge only',
        role: 'text',
    },
    ...
    deviceType: {
        ...
        type: 'number',
        role: 'value',
        common: { states: { 0: 'Nuki Smart Lock', 2: 'Nuki Opener' } },
    },
    ...
    firmwareVersion: {
        state: 'info.firmwareVersion',
        description: 'The firmware version',
        type: 'number',
        role: 'value',
    },
    hardwareVersion: {
        state: 'info.hardwareVersion',
        description: 'The hardware version',
        type: 'number',
        role: 'value',
    },
    operationId: {
        state: 'info.operationId',
        description: 'The operation id - if set the device is locked for another operation',
        type: 'string',
        role: 'text',
    },
    serverState: {
        ...
        type: 'number',
        role: 'value',
        common: { states: { 0: 'OK', 1: 'UNREGISTERED', 2: 'AUTH UUID INVALID', 3: 'AUTH INVALID', 4: 'OFFLINE' } },
    },
    adminPinState: {
        state: 'info.adminPinState',
        description: 'The admin pin state',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'OK', 1: 'MISSING', 2: 'INVALID' } },
    },
    virtualDevice: {
        state: 'info.virtualDevice',
    ...
    'state.batteryCritical': {
        description: 'Indicates critical battery level',
    ...
    'state.doorsensorState': {
        ...
        description: 'Current door-state of the Nuki',
        type: 'number',
        role: 'value',
        common: { states: LOCK.DOOR },
    },
    'state.doorsensorStateName': {
        state: 'state.doorStateName',
        description: 'Current door-state name of the Nuki',
        type: 'string',
        role: 'text',
    },
    ...
    'state.state': {
        ...
        description: 'Current lock-state of the Nuki or Opener',
        type: 'number',
        role: 'value',
    },
    'state.stateName': {
        state: 'state.lockStateName',
        description: 'Current lock-state name of the Nuki or Opener',
        type: 'string',
        role: 'text',
    },
    'state.mode': {
        description: 'Operation Mode of the Nuki or Opener',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'UNINITIALIZED', 1: 'PAIRING', 2: 'NORMAL', 3: 'CONTINUOUS', 4: 'MAINTENANCE' } },
    },
    'state.ringToOpenTimer': { description: 'Remaining ring to open time', type: 'number', role: 'value' },
    'state.trigger': {
        description: 'The state trigger',
        type: 'number',
        role: 'value',
        common: {
            states: { 0: 'SYSTEM', 1: 'MANUAL', 2: 'BUTTON', 3: 'AUTOMATIC', 4: 'WEB', 5: 'APP', 6: 'CONTINUOUS' },
        },
    },
    'state.timestamp': {
        state: 'state.lastDataUpdate',
        description: 'Timestamp of last data update / refresh',
        role: 'date',
    },
    ...
    'state.locked': {
        state: 'state.locked',
        description: 'Indication if door is locked (boolean of lockState)',
        type: 'boolean',
        role: 'sensor.lock',
        common: {
            states: {
    ...
    'state.closed': {
        state: 'state.closed',
        description: 'Indication if door is closed (boolean of doorState)',
        type: 'boolean',
        role: 'sensor.lock',
        common: { states: { 0: 'false', 1: 'false', 2: 'true', 3: 'false', 4: 'true', 5: 'false' } },
    },
    ...
    'users.type': {
        ...
        role: 'value',
        common: {
            states: { 0: 'APP', 1: 'BRIDGE', 2: 'FOB', 3: 'KEYPAD', 13: 'KEYPAD CODE', 14: 'Z-KEY', 15: 'VIRTUAL' },
        },
    },
    ...
    'config.capabilities': {
        description: 'The capabilities indicate whether door opening is possible via App, RTO or both',
        type: 'number',
        role: 'indicator',
        common: { states: { 0: 'ONLY DOOR', 1: 'BOTH', 2: 'ONLY RTO' } },
    },
    'config.daylightSavingMode': {
        description: 'The daylight saving mode',
        type: 'number',
        role: 'indicator',
        common: { states: { 0: 'OFF', 1: 'EUROPEAN' } },
    },
    'config.name': { description: 'The name of the smartlock for new users', type: 'string', role: 'text' },
    'config.operatingMode': {
        description: 'The operating mode of the opener',
        type: 'number',
        role: 'indicator',
        common: { states: { 0: 'GENERIC DOOR OPENER', 1: 'ANALOGUE INTERCOM', 2: 'DIGITAL INTERCOM' } },
    },
    ...
    'config.longitude': {
        state: 'config.gpsLongitude',
        description: 'Longitude',
        role: 'gps.longitude',
        type: 'number',
    },
    'config.autoUnlatch': {
        description: 'True if the door should be unlatched on unlocking (knob)',
        role: 'indicator',
        type: 'boolean',
    },
    'config.pairingEnabled': {
    ...
    'config.ledBrightness': {
        description: 'The brightness of the LED: 0 (off) to 5 (max)',
    ...
    'config.fobAction1': {
        description: 'The fob action if button is pressed once',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NONE', 1: 'UNLOCK', 2: 'LOCK', 3: 'LOCK_N_GO', 4: 'INTELLIGENT' } },
    },
    'config.fobAction2': {
        description: 'The fob action if button is pressed twice',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NONE', 1: 'UNLOCK', 2: 'LOCK', 3: 'LOCK_N_GO', 4: 'INTELLIGENT' } },
    },
    'config.fobAction3': {
        description: 'The fob action if button is pressed 3 times',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NONE', 1: 'UNLOCK', 2: 'LOCK', 3: 'LOCK_N_GO', 4: 'INTELLIGENT' } },
    },
    ...
    'config.advertisingMode': {
        description: 'The advertising mode (battery saving)',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'AUTOMATIC', 1: 'NORMAL', 2: 'SLOW', 3: 'SLOWEST' } },
    },
    'config.keypadPaired': {
    ...
    'config.homekitState': {
        description: 'The homekit state',
        role: 'indicator',
        type: 'number',
        common: { states: { 0: 'UNAVAILABLE', 1: 'DISABLED', 2: 'ENABLED', 3: 'ENABLED & PAIRED' } },
    },
    ...
    'advancedConfig.singleButtonPressAction': {
        description: 'The desired action, if the button is pressed once',
        type: 'number',
        role: 'value',
        common: { states: LOCK.BUTTON },
    },
    'advancedConfig.doubleButtonPressAction': {
        description: 'The desired action, if the button is pressed twice',
        type: 'number',
        role: 'value',
        common: { states: LOCK.BUTTON },
    },
    'advancedConfig.detachedCylinder': {
        description: 'Flag that indicates that the inner side of the used cylinder is detached from the outer side',
        type: 'boolean',
        role: 'indicator',
    },
    'advancedConfig.batteryType': {
        description: 'The type of the batteries present in the smart lock',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'ALKALI', 1: 'ACCUMULATOR', 2: 'LITHIUM' } },
    },
    'advancedConfig.automaticBatteryTypeDetection': {
        description: 'Flag that indicates if the automatic detection of the battery type is enabled',
        type: 'boolean',
        role: 'indicator',
    },
    'advancedConfig.unlatchDuration': {
        description: 'Duration in seconds for holding the latch in unlatched position',
        role: 'value',
        type: 'number',
    },
    'advancedConfig.autoLockTimeout': {
        description:
    ...
    'webConfig.batteryWarningPerMailEnabled': {
    ...
    'openerAdvancedConfig.doorbellSuppressionDuration': {
        description: 'Duration in ms of doorbell suppression (only in Operating mode 2 -digital Intercom-)',
        type: 'number',
        role: 'value',
    },
    'openerAdvancedConfig.soundRing': {
        description: 'The sound for ring',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NO SOUND', 1: 'SOUND 1', 2: 'SOUND 2', 3: 'SOUND 3' } },
    },
    'openerAdvancedConfig.soundOpen': {
        description: 'The sound for open',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NO SOUND', 1: 'SOUND 1', 2: 'SOUND 2', 3: 'SOUND 3' } },
    },
    'openerAdvancedConfig.soundRto': {
        description: 'The sound for RTO',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NO SOUND', 1: 'SOUND 1', 2: 'SOUND 2', 3: 'SOUND 3' } },
    },
    'openerAdvancedConfig.soundCm': {
        description: 'The sound for CM',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NO SOUND', 1: 'SOUND 1', 2: 'SOUND 2', 3: 'SOUND 3' } },
    },
    'openerAdvancedConfig.soundConfirmation': {
        description: 'The sound confirmation',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'NO SOUND', 1: 'SOUND' } },
    },
    'openerAdvancedConfig.soundLevel': { description: 'The sound level', type: 'number', role: 'value' },
    'openerAdvancedConfig.singleButtonPressAction': {
        description: 'The desired action, if the button is pressed once',
        type: 'number',
        role: 'value',
        common: { states: OPENER.BUTTON },
    },
    'openerAdvancedConfig.doubleButtonPressAction': {
        description: 'The desired action, if the button is pressed twice',
        type: 'number',
        role: 'value',
        common: { states: OPENER.BUTTON },
    },
    'openerAdvancedConfig.batteryType': {
        description: 'The type of the batteries present in the smart lock',
        type: 'number',
        role: 'value',
        common: { states: { 0: 'ALKALI', 1: 'ACCUMULATOR', 2: 'LITHIUM' } },
    },
    'openerAdvancedConfig.automaticBatteryTypeDetection': {
        description: 'Flag that indicates if the automatic detection of the battery type is enabled',
        type: 'boolean',
        role: 'indicator',
    },
    'openerAdvancedConfig.operationId': {
        description: 'The operation id - if set device is locked for another operation',
        type: 'string',
        role: 'text',
    },
};
