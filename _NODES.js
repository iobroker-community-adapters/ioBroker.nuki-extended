...
module.exports =
{
	...
	'ids.serverId': {'state': 'bridgeId', 'description': 'ID of the bridge / server', 'role': 'value'},
	...
	'ids.hardwareId': {'state': 'hardwareId', 'description': 'ID of the hardware bridge', 'role': 'value'},
	...
	'config.latitude': {'state': 'config.gpsLatitude', 'description': 'Latitude', 'role': 'gps.latitude'},
	'config.longitude': {'state': 'config.gpsLongitude', 'description': 'Longitude', 'role': 'gps.longitude'},
	'config.autoUnlatch': {'description': 'True if the door should be unlatched on unlocking (knob)', 'role': 'indicator'},
	'config.pairingEnabled': {'description': 'True if the pairing is allowed via the smartlock button', 'role': 'indicator'},
	'config.buttonEnabled': {'description': 'True if the button on the smartlock is enabled', 'role': 'indicator'},
	'config.ledEnabled': {'description': 'True if the LED on the smartlock is enabled', 'role': 'indicator'},
	'config.ledBrightness': {'description': 'The brightness of the LED: 0 (off) to 5 (max)', 'role': 'value.brightness'},
	'config.fobPaired': {'description': 'True if a fob is paired with the smartlock', 'role': 'indicator'},
	'config.fobAction1': {'description': 'The fob action if button is pressed once', 'role': 'value', 'common': {'states': {'0': 'NONE', '1': 'UNLOCK', '2': 'LOCK', '3': 'LOCK_N_GO', '4': 'INTELLIGENT'}}},
	'config.fobAction2': {'description': 'The fob action if button is pressed twice', 'role': 'value', 'common': {'states': {'0': 'NONE', '1': 'UNLOCK', '2': 'LOCK', '3': 'LOCK_N_GO', '4': 'INTELLIGENT'}}},
	'config.fobAction3': {'description': 'The fob action if button is pressed 3 times', 'role': 'value', 'common': {'states': {'0': 'NONE', '1': 'UNLOCK', '2': 'LOCK', '3': 'LOCK_N_GO', '4': 'INTELLIGENT'}}},
	'config.singleLock': {'description': 'True if the smartlock should only lock once (instead of twice)', 'role': 'indicator'},
	'config.advertisingMode': {'description': 'The advertising mode (battery saving)', 'role': 'value', 'common': {'states': {'0': 'AUTOMATIC', '1': 'NORMAL', '2': 'SLOW', '3': 'SLOWEST'}}},
	'config.keypadPaired': {'description': 'True if a keypad is paired with the smartlock', 'role': 'indicator'},
	'config.homekitState': {'description': 'The homekit state', 'role': 'indicator', 'common': {'states': {'0': 'UNAVAILABLE', '1': 'DISABLED', '2': 'ENABLED', '3': 'ENABLED & PAIRED'}}},
	'config.timezoneId': {'description': 'The timezone id', 'role': 'value'},
	
	// SMARTLOCK - ADVANCED CONFIG
	'advancedConfig': {'description': 'Advanced Configuration', 'role': 'channel'},
	'advancedConfig.totalDegrees': {'description': 'The absolute total position in degrees that has been reached during calibration', 'role': 'value'},
	'advancedConfig.unlockedPositionOffsetDegrees': {'description': 'Offset that alters the unlocked position', 'role': 'value'},
	'advancedConfig.lockedPositionOffsetDegrees': {'description': 'Offset that alters the locked position', 'role': 'value'},
	'advancedConfig.singleLockedPositionOffsetDegrees': {'description': 'Offset that alters the single locked position', 'role': 'value'},
	'advancedConfig.unlockedToLockedTransitionOffsetDegrees': {'description': 'Offset that alters the position where transition from unlocked to locked happens', 'role': 'value'},
	'advancedConfig.lngTimeout': {'description': 'Timeout in seconds for lock ‘n’ go', 'role': 'value'},
	'advancedConfig.singleButtonPressAction': {'description': 'The desired action, if the button is pressed once', 'role': 'value', 'common': {'states': LOCK.BUTTON}},
	'advancedConfig.doubleButtonPressAction': {'description': 'The desired action, if the button is pressed twice', 'role': 'value', 'common': {'states': LOCK.BUTTON}},
	...
	'advancedConfig.batteryType': {'description': 'The type of the batteries present in the smart lock', 'role': 'value', 'common': {'states': {'0': 'ALKALI', '1': 'ACCUMULATOR', '2': 'LITHIUM'}}},
